Loader.addToManifest(Loader.manifest,{
  // Voice
  test1: "assets/sounds/coin_get.mp3",
  slide1v0: "assets/voice/slide1_0.mp3",
  slide1v1: "assets/voice/slide1_1.mp3"
});
...
SLIDES.push({
    ...
    Loader.sounds.slide1v0.play(); //slide1_0
	...
	onstart: function(self){
      ...
      //Loader.sounds.test1.play(); //slide1_1A
		}else{
			t.setText(Words.get("oneoff_1_cheated")+"<br>"+Words.get("oneoff_1_top"));
      //Loader.sounds.test1.play(); //slide1_1B
		}
	...
	onstart: function(self){
      ...
      //Loader.sounds.test1.play(); //slide1_2A
		}else{
			t.setText(Words.get("oneoff_2_cheated")+"<br>"+Words.get("oneoff_2_top"));
      //Loader.sounds.test1.play(); //slide1_2B
		}
		self.add({

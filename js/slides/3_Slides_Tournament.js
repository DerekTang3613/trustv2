Loader.addToManifest(Loader.manifest,{
  ...
  test3: "assets/sounds/coin_get.mp3",
  slide3v0: "assets/voice/slide3_0.mp3"
});
...
SLIDES.push({
    ...
    Loader.sounds.slide3v0.play(); //slide3_0
...
SLIDES.push({
    ...
    //Loader.sounds.test3.play(); //slide3_1
...
SLIDES.push({
	onstart: function(self){
      ...
      //Loader.sounds.test3.play(); //slide3_? maybe need some extra work here
...
SLIDES.push({
    ...
    //Loader.sounds.test3.play(); //slide3_end + maybe need buffer

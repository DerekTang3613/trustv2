Loader.addToManifest(Loader.manifest,{
  ...
  // voice
  test4: "assets/sounds/coin_get.mp3",
  slide4v0: "assets/voice/slide4_0.mp3",
  slide4v1: "assets/voice/slide4_1.mp3",
  slide4v2: "assets/voice/slide4_2.mp3",
  slide4v3: "assets/voice/slide4_3.mp3"
});
...
SLIDES.push({
    ...
    Loader.sounds.slide4v0.play(); //slide4_0
		// WORDS
		self.add({
...
SLIDES.push({
    ...
    Loader.sounds.slide4v1.play(); //slide4_0
		// BETS
...
SLIDES.push({
    ...
    //Loader.sounds.test4.play(); //slide4_0
		...
		listen(_, "tournament/step/completed", function(step){
            ...
            //Loader.sounds.test4.play(); //slide4_1 maybe need to use something else here like the line above
					}else{
						response = Words.get("evo_"+textStep);
            //Loader.sounds.test4.play(); //slide4_2 need changes
					}
					o.text.setText(response);
					_hide(o.text); _fadeIn(o.text, 100);
					_showButtons();
					...
					publish("slideshow/next");
          //Loader.sounds.test4.play(); //slide4_3 need changes
				}
			}
		});
...
SLIDES.push({
    ...
    //Loader.sounds.test4.play(); //slide4_4
...
SLIDES.push({
    ...
    //Loader.sounds.test4.play(); //slide4_5
      ...
      //Loader.sounds.test4.play(); //slide4_6
      ...
      Loader.sounds.slide4v2.play(); //slide4_7
...
SLIDES.push({
    ...
    Loader.sounds.slide4v3.play(); //slide4_8

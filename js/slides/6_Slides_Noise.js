Loader.addToManifest(Loader.manifest,{
  // Voice
  test6: "assets/sounds/coin_get.mp3",
  test6a: "assets/sounds/drumroll.mp3",
  test6b: "assets/sounds/squeak.mp3",
  test6c: "assets/sounds/bonk.mp3",
  
  slide6v0: "assets/voice/slide6_0.mp3",
  slide6v1: "assets/voice/slide6_1.mp3"
});
...
SLIDES.push({
    ...
    //Loader.sounds.test6.play(); //slide6_0

		// STAGES
    // voice added, maybe need buffer, slide6_1~4
		var STAGES = [
			{button:"cooperate", message:"cooperate"}, // , voice: Loader.sounds.test6
			{button:"cooperate", message:"TRIP"}, // , voice: Loader.sounds.test6a
			{button:"cooperate", message:"cooperate"}, // , voice: Loader.sounds.test6b
			{button:"cheat", message:"cheat"} // , voice: Loader.sounds.test6c
		];
		var STAGE_INDEX = 0;
...
SLIDES.push({
    ...
    Loader.sounds.slide6v0.play(); //slide6_5
    ...
    //Loader.sounds.test6.play(); //slide6_6
...
SLIDES.push({
    ...
    Loader.sounds.slide6v1.play(); //slide6_7
...
SLIDES.push({
    ...
    //Loader.sounds.test6.play(); //slide6_8
		...
		listen(_.misc, "tournament/step/completed", function(step){
          ...
          //Loader.sounds.test6.play(); //slide6_9
...
SLIDES.push({
    ...
    //Loader.sounds.test6.play(); //slide6_10
...
SLIDES.push({
    ...
    //Loader.sounds.test6.play(); //slide6_11
		...
		listen(_.misc, "tournament/step/completed", function(step){
          ...
          //Loader.sounds.test6.play(); //slide6_12 maybe not needed
...
SLIDES.push({
    ...
    //Loader.sounds.test6.play(); //slide6_13
...
SLIDES.push({
    ...
    //Loader.sounds.test6.play(); //slide6_14
